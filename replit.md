...
*   **AI Futures Trader:**
    ...
    *   **Pattern Detection (Live Scanner):** Detects 5 live patterns: 3 Bar Play, Buy/Sell Setup, Pivot Breakout, Climax/Exhaustion Reversal, and Wedge Breakout (falling wedge long / rising wedge short with linear regression slope convergence + volume surge + breakout confirmation). Backtester additionally supports Retest, Cup & Handle, and 4 Bar Play. All patterns have individual long/short toggles.
